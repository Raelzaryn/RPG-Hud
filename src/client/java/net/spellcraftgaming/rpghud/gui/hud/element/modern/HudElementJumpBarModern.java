...
public class HudElementJumpBarModern extends HudElement {
	...
	public void drawElement(DrawContext dc, float zLevel, float partialTicks, int scaledWidth, int scaledHeight) {
		...
		drawRect(dc, scaledWidth / 2 - 72 + posX, height - 78, 144, 2, 0xA0000000);
		drawRect(dc, scaledWidth / 2 - 72 + posX, height - 70, 144, 2, 0xA0000000);
		drawRect(dc, scaledWidth / 2 - 72 + posX, height - 76, 2, 6, 0xA0000000);
		drawRect(dc, scaledWidth / 2 + 70 + posX, height - 76, 2, 6, 0xA0000000);
		drawRect(dc, scaledWidth / 2 - 70 + posX, height - 76, 140, 6, 0x20FFFFFF);
		drawRect(dc, scaledWidth / 2 - 70 + posX, height - 76, (int) (140 * (value / 100.0D)), 6, this.settings.getIntValue(Settings.color_jump_bar));
	}
