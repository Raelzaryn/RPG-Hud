...
public record ColoredTetragonGuiElementRenderState(
	...
	public ColoredTetragonGuiElementRenderState(
		RenderPipeline pipeline, TextureSetup textureSetup, Matrix3x2fc pose, int posX1, int posX2, int posY1, int posY2, int width1, int width2, int height1, int height2, int color, @Nullable ScreenRectangle scissorArea
	) {
	...
	@Nullable
	private static ScreenRectangle createBounds(int posX1, int posX2, int posY1, int posY2, int width1, int width2, int height1, int height2, Matrix3x2fc pose, @Nullable ScreenRectangle scissorArea) {
		int left = 0;
		int right = 0;
		int top = 0;
		int bottom = 0;
