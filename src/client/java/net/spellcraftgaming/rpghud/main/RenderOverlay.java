...
public class RenderOverlay implements HudElement {
	...
	private void renderOverlay(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
		...
		if(!shouldRenderVanilla(HudElementType.HEALTH))
			this.drawElement(HudElementType.HEALTH, graphics, deltaTracker);
		...
		if(!shouldRenderVanilla(HudElementType.HEALTH_MOUNT))
			this.drawElement(HudElementType.HEALTH_MOUNT, graphics, deltaTracker);
		...
		if(!shouldRenderVanilla(HudElementType.JUMP_BAR))
			this.drawElement(HudElementType.JUMP_BAR, graphics, deltaTracker);
		if(!shouldRenderVanilla(HudElementType.STATUS_EFFECTS))
			this.drawElement(HudElementType.STATUS_EFFECTS, graphics, deltaTracker);
