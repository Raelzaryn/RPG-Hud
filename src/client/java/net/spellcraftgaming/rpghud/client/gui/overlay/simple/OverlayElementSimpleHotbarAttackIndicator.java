...
public class OverlayElementSimpleHotbarAttackIndicator extends OverlayElement {
	...
	public OverlayElementSimpleHotbarAttackIndicator() {
		super(Type.ATTACK_INDICATOR, 18, 18);
	...
	public void initialize() {
		...
		this.parentAnchor = new OverlayParentAnchor(Type.HOTBAR, X_ANCHOR_RIGHT, Y_ANCHOR_CENTER, 2, 0);
	...
	public void render(DrawContext dc, float tickDelta) {
		...
		int posX = getPosX();
		int posY = getPosY();
        if(instance.options.getAttackIndicator().getValue() == AttackIndicator.HOTBAR) {
