...
public class TextFieldWidgetMod extends TextFieldWidget {
    ...
    public TextFieldWidgetMod(TextRenderer fontIn, ValueType type, String setting, int xIn, int yIn, int widthIn, int heightIn, String msg) {
        super(fontIn, xIn, yIn, widthIn, heightIn, msg);
        this.type = type;
        this.enumOptions = setting;
    }
    
    public TextFieldWidgetMod(TextRenderer fontIn, ValueType type, int xIn, int yIn, int widthIn, int heightIn, String msg) {
        super(fontIn, xIn, yIn, widthIn, heightIn, msg);
        this.type = type;
