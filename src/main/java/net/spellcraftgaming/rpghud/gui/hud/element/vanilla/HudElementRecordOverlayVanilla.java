...
public class HudElementRecordOverlayVanilla extends HudElement {
    ...
    public void drawElement(Gui gui, float zLevel, float partialTicks) {
        ...
        if(l1 > 8) {
            ...
            GameData.getFontRenderer().drawString(GameData.getOverlayText(guiIngame),
                    -GameData.getFontRenderer().getStringWidth(GameData.getOverlayText(guiIngame)) / 2, -4, l + (l1 << 24 & -16777216));
