...
public class HudElementClockExtended extends HudElementClockVanilla {
	...
	public void drawElement(Gui gui, float zLevel, float partialTicks) {
		...
		gui.drawString(GameData.getFontRenderer(), getTime(), (this.settings.getBoolValue(Settings.reduce_size) ? 8 : 4) + this.settings.getPositionValue(Settings.clock_position)[0], (this.settings.getBoolValue(Settings.reduce_size) ? 124 : 62) + this.settings.getPositionValue(Settings.clock_position)[1], clockColor);
