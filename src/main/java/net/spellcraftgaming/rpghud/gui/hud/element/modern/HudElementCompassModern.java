...
public class HudElementCompassModern extends HudElement {
	...
	public void drawElement(Gui gui, float zLevel, float partialTicks) {
		...
		if (this.settings.getBoolValue(Settings.enable_compass_coordinates)) {
			...
			drawRect((int) (width - ((float) GameData.getFontRenderer().getStringWidth(String.valueOf(pos[1])) / 4) - 2), posY + 11, GameData.getFontRenderer().getStringWidth(String.valueOf(pos[1])) / 2 + 4, 6, 0xA0000000);
			drawRect((width + 48) - (GameData.getFontRenderer().getStringWidth(String.valueOf(pos[2])) / 2) - 2, posY + 11, GameData.getFontRenderer().getStringWidth(String.valueOf(pos[2])) / 2 + 4, 6, 0xA0000000);
			...
			gui.drawString(GameData.getFontRenderer(), String.valueOf(pos[2]), (width + 48) * 2 - GameData.getFontRenderer().getStringWidth(String.valueOf(pos[2])), (posY + 12) * 2, -1);
