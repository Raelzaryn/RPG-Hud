...
public class HudElementCompassModern extends HudElementCompassVanilla {
    ...
    public void drawElement(AbstractGui gui, float zLevel, float partialTicks, int scaledWidth, int scaledHeight) {
        ...
        if(this.settings.getBoolValue(Settings.enable_compass_coordinates)) {
            ...
            drawRect((int) (width - ((float) this.mc.fontRenderer.getStringWidth(String.valueOf(pos[1])) / 4) - 2), posY + 11,
                    this.mc.fontRenderer.getStringWidth(String.valueOf(pos[1])) / 2 + 4, 6, 0xA0000000);
            ...
            gui.drawString(this.mc.fontRenderer, String.valueOf(pos[2]), (width + 48) * 2 - this.mc.fontRenderer.getStringWidth(String.valueOf(pos[2])),
                    (posY + 12) * 2, -1);
