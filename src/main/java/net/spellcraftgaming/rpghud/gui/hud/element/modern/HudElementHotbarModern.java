...
public class HudElementHotbarModern extends HudElement {
    ...
    public void drawElement(Gui gui, float zLevel, float partialTicks, int scaledWidth, int scaledHeight) {
        if(this.mc.playerController.isSpectator()) {
            ...
            float f = zLevel;
            zLevel = -90.0F;
            drawRect(scaledWidth / 2 - 91 + posX, height - 22 - 5, 182, 2, 0xA0000000);
            if(GameData.isPlayerCreative())
                drawRect(scaledWidth / 2 - 91 + posX, height - 7, 182, 2, 0xA0000000);
            for(int x = 0; x < 10; x++) {
                drawRect(scaledWidth / 2 - 91 + (x * 20) + posX, height - 22 - 3, 2, 18, 0xA0000000);
                if(x < 9) {
                    drawRect(scaledWidth / 2 - 91 + 2 + (x * 20) + posX, height - 22 - 3, 18, 18, 0x60000000);
                }
            }
            drawRect(scaledWidth / 2 - 91 + 2 + (entityplayer.inventory.currentItem * 20) + posX, height - 22 - 3, 18, 18, 0x40FFFFFF);
            GlStateManager.enableAlpha();
            if(itemstack != GameData.nullStack()) {
                if(enumhandside == 0) {
                    drawRect(scaledWidth / 2 - 91 - 24 + posX, height - 22 - 5, 22, 2, 0xA0000000);
                    drawRect(scaledWidth / 2 - 91 - 24 + posX, height - 22 - 3, 2, 18, 0xA0000000);
                    drawRect(scaledWidth / 2 - 91 - 4 + posX, height - 22 - 3, 2, 18, 0xA0000000);
                    drawRect(scaledWidth / 2 - 91 + 2 - 24 + posX, height - 22 - 3, 18, 18, 0x60000000);
                    if(GameData.isPlayerCreative())
                        drawRect(scaledWidth / 2 - 91 - 24 + posX, height - 7, 22, 2, 0xA0000000);
                } else {
                    drawRect(scaledWidth / 2 - 91 - 24 + 209 + posX, height - 22 - 5, 22, 2, 0xA0000000);
                    drawRect(scaledWidth / 2 - 91 - 24 + 209 + posX, height - 22 - 3, 2, 18, 0xA0000000);
                    drawRect(scaledWidth / 2 - 91 - 4 + 209 + posX, height - 22 - 3, 2, 18, 0xA0000000);
                    drawRect(scaledWidth / 2 - 91 + 2 - 24 + 209 + posX, height - 22 - 3, 18, 18, 0x60000000);
                    if(GameData.isPlayerCreative())
                        drawRect(scaledWidth / 2 - 91 - 24 + 209 + posX, height - 7, 22, 2, 0xA0000000);
                }
            }
