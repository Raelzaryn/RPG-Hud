...
public class GuiSettingsModColor extends GuiScreenTooltip {
    ...
    public void func_231160_c_() {
        ...
        this.colorCodeField = new TextFieldWidget(field_230706_i_.fontRenderer, this.field_230708_k_ / 2 - 74, 115, 147, 20,
        ...
        for(int i = 0; i < 6; i++) {
            this.func_230480_a_(
                    new GuiButtonTooltip(10 + i, this.field_230708_k_ / 4 * 3 - 20, 40 + (i * 20), 60, 20, new TranslationTextComponent(colorString[i]), button -> {
                        actionPerformed(button);
                    }));
        }

        for(int i = 0; i < 6; i++) {
            this.func_230480_a_(new GuiButtonTooltip(16 + i, this.field_230708_k_ / 4 * 3 + 60 - 20, 40 + (i * 20), 60, 20,
        ...
        this.func_230480_a_(
                new GuiButtonTooltip(this.field_230708_k_ / 2 - 100, this.field_230709_l_ / 6 + 168, 125, 20, new TranslationTextComponent("gui.done"), button -> {
                    setSettingColor();
                    field_230706_i_.displayGuiScreen(parent);
                }).setTooltip(I18n.format("tooltip.done", new Object[0])));
        this.func_230480_a_(
                new GuiButtonTooltip(this.field_230708_k_ / 2 + 24, this.field_230709_l_ / 6 + 168, 75, 20, new TranslationTextComponent("gui.cancel"), button -> {
                    field_230706_i_.displayGuiScreen(parent);
