...
@Mod(modid = ModRPGHud.MOD_ID, version = ModRPGHud.VERSION, name = ModRPGHud.NAME, clientSideOnly = ModRPGHud.CLIENT_SIDE_ONLY, canBeDeactivated = ModRPGHud.CAN_BE_DEACTIVATED, useMetadata = ModRPGHud.USE_METADATA, guiFactory = ModRPGHud.GUI_FACTORY)
