...
public class GameData {
	...
	public static int addArrowStackIfCorrect(ItemStack item, ItemStack arrow) {
		...
		/*
		 * PotionType type1 = null; if (item.getItem() instanceof
		 * ItemTippedArrow) type1 =
		 * PotionUtils.getPotionTypeFromNBT(item.getTagCompound()); if
		 * (item.getItem() instanceof ItemTippedArrow) { PotionType type2 =
