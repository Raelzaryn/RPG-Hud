...
public class HudElementClockVanilla extends HudElement{
	...
	public void drawElement(Gui gui, float zLevel, float partialTicks) {
		...
		if(this.settings.reduce_size) GL11.glScaled(0.5D, 0.5D, 0.5D);
		...
		if(this.settings.reduce_size) GL11.glScaled(2.0D, 2.0D, 2.0D);
	}
	...
	public String getTime(){
		...
		if(currentHour > 24) currentHour -= 24L;
	...
	public int getClockColor(){
		...
		long day = this.mc.world.getWorldTime() / 24000L;
		long currentTime = time - (24000L * day);
		if(currentTime < 1000) return 0xFFAF00;
		else if(currentTime < 6000) return 0xFFAF00;
		else if(currentTime < 11000) return 0xFFCF00;
		else if(currentTime < 12000) return 0xFFAF00;
		else if(currentTime < 13000) return 0xFFA200;
		else if(currentTime < 13500) return 0xE36E21;
		else if(currentTime < 18000) return 0x345D74;
		else if(currentTime < 21000) return 0x1F3847;
		else if(currentTime < 22250) return 0x345D74;
		else if(currentTime < 22500) return 0x775D74;
		else if(currentTime < 23000) return 0xE36E21;
		else return 0xFFA200;
	}
